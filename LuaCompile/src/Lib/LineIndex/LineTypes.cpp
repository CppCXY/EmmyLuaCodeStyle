#include "LuaCompile/Lib/LineIndex/LineTypes.h"
...
std::size_t LineOffset::GetCol(std::size_t colOffset) const {
    std::size_t col = 0;
...
std::size_t LineOffset::GetOffset(std::size_t colNum) const {
